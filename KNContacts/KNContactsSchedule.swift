...
public struct KNContactsSchedule {
    ...
    */
    ...
    /**
     ...
     - Returns:
     Adictionary of date strings, each holding the schedule of contacts as an array of contact identifers for that date.
    ...
    /**
    Resets the schedule by invalidating the collection.
